...
try:
    ...
    print(
        "Warning: FAISS or sentence-transformers not available. Vector search disabled."
    )
...
class MemoryStorage:
    ...
    def _load_or_create_index(self):
        ...
        index_path = os.path.join(self.embeddings_dir, "faiss.index")
    ...
    def _load_or_create_id_map(self):
        ...
        map_path = os.path.join(self.embeddings_dir, "id_map.pkl")
    ...
    def _save_index(self):
        ...
        os.makedirs(self.embeddings_dir, exist_ok=True)
        faiss.write_index(self.index, os.path.join(self.embeddings_dir, "faiss.index"))

        with open(os.path.join(self.embeddings_dir, "id_map.pkl"), "wb") as f:
    ...
    def search_memories_by_content(
        ...
        distances, indices = self.index.search(
            query_embedding, min(top_k * 2, len(self.memory_id_map))
        )
    ...
    def _text_search(
        self, query: str, session_id: Optional[str], top_k: int
    ) -> List[Dict[str, Any]]:
